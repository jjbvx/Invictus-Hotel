...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
      <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT;?>images/logo11.png" alt=""><img class="logo_2" src="<?php echo WEB_ROOT;?>images/logo_2.png" alt=""><img class="logo_3" src="<?php echo WEB_ROOT;?>images/logo_3.png" alt=""></a></div>

      <!-- Main Nav -->
      <nav class="main_nav">
        <ul class="d-flex flex-row align-items-center justify-content-start">
           <li><a href="<?php echo WEB_ROOT;?>index.php">Inicio</a></li>
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=about">Saber Más</a></li>
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=rooms">Habitaciones</a></li> 
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=contact">Contactanos</a></li>
        </ul>
      </nav>
...
<!--         <div class="search_button">
        ...
        <!-- Header Link -->
        <div class="header_link"><a href="#">Reserva Ahora</a></div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_title"><h1>Reserva en el mejor Hotel</h1></div>
      <div class="home_text text-center">"Descubre el encanto y la grandeza en Hotel Invictus, donde tus sueños se hacen realidad"</div>
    </div>
  </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Correo</div>
                    <div>hotelinvictus@gmai.com</div>
                  </div>
                </div>
              </div>
            </div>
